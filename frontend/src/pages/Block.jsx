...
const formSchema = z.object({
  ...
  username: z
    .string()
    .min(1, { message: 'El nombre de usuario es muy corto' })
  ...
  async function onSubmit (values) {
    ...
    if (isEdit) {
      const hasChanges = (
        ...
        values.role_id !== getRoleId(user.role) ||
        values.status_id !== getStatusId(user.status)
      )
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input id='email' placeholder='Ingres el corre electrónico' {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
